...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-lg"><b>IPHALL</span>
    </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- <li class="user-body">
                                <div class="col-xs-4 text-center">
                                    <a href="#"><span style="color: green;">{{ trans('adminlte_lang::message.followers') }}</span></a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="#"><span style="color: darkblue;">{{ trans('adminlte_lang::message.sales') }}</span></a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="#"><span style="color: orange;">{{ trans('adminlte_lang::message.friends') }}</span></a>
                                </div>
                            </li> -->
                            <!-- Menu Footer-->
